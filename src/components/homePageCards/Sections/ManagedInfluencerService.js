...
export default function ManagedInfluencerService() {
            ...
            <Box className={classes.uppercard} disableRipple={true}>
              ...
              >
                ...
                {/* <Typography variant="h3" style={{marginLeft:'0%',marginBottom:30}}>Chauffeur-Driven Exotic Car Rentals in Lagos</Typography> */}
                  ...
                  >
                    <Typography variant="h3" style={{marginLeft:'0%',marginBottom:20}}>Managed Influencer Marketing Service</Typography>
                    ...
                    <Typography style={{marginTop:20, fontSize:15}}>
                          <ReactMarkdown>Let us handle everything from start to finish. You choose your preferred influencers, and our team takes care of the rest — campaign management, communication, performance tracking, and reporting — ensuring a seamless, results-driven influencer marketing experience. </ReactMarkdown>
                    </Typography>
             ...
             <Grid
              ...
              >
                ...
                {/* <Typography style={{marginTop:0, padding: 70}}>
                  ...
                  >
                   <Typography variant="h5" style={{marginLeft:'0%',marginBottom:30, fontWeight:700}}>Managed Influencer Marketing Service</Typography>
