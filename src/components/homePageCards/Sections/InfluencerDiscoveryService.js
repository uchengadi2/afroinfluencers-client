        ...
        <>
          {matchesMDUp ? (
              ...
              <Box className={classes.uppercard} disableRipple={true}>
                ...
                >
                  ...
                  {/* <Typography variant="h4" style={{marginLeft:'50%',marginBottom:30, fontSize:30, fontWeight:700, color:"black"}}>Airport Protocol Services</Typography> */}
                    ...
                    >
                      <Typography variant="h3" style={{marginLeft:'0%',marginBottom:30}}>Influencer Discovery & Self-Management Service</Typography>
                     {/* <Typography style={{marginTop:0, padding: 0,fontSize:17}}>
                      ...
                      <Typography style={{marginTop:10, fontSize:15}}>
                            <ReactMarkdown>Take full control of your influencer marketing with our subscription-based platform. Gain direct access to our comprehensive influencer database, explore detailed profiles, and manage recruitment and vetting independently — all within one powerful tool.</ReactMarkdown>
                      </Typography>
            ...
            <Box className={classes.uppercardMobile} disableRipple>
                <Typography variant="h3" style={{marginLeft:'20%',marginBottom:30,fontSize:25}}>Our Brand Services</Typography>
                    ...
                    <Grid
                          ...
                          >
                            ...
                            {/* <Typography style={{marginTop:0, padding: 70}}>
                              ...
                              >
                               <Typography variant="h5" style={{marginLeft:'0%',marginBottom:30, fontWeight:700}}>Influencer Discovery & Self-Management Service</Typography>
