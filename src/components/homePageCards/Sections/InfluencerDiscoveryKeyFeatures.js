...
export default function InfluencerDiscoveryKeyFeatures(props) {
  ...
  const keyFeatures = "* **Advanced Influencer Discovery**: Find the right creators in seconds. Leverage powerful filters — including niche, audience demographics, engagement rate, follower count, and location — to identify influencers who align perfectly with your brand and campaign objectives.\n\n* **Verified Influencer Profiles**: Access reliable, data-driven creator insights. Each profile includes verified engagement metrics, audience breakdowns, and performance indicators, empowering you to make confident, informed partnership decisions.\n\n* **Direct Engagement & Communication**: Connect with influencers seamlessly through verified contact details. Share briefs, negotiate partnership terms, and manage conversations — all directly from the platform, with no intermediaries.\n\n* **Flexible Subscription Plans**: Choose a plan that fits your needs. Enjoy transparent pricing with the option to subscribe monthly at ₦268,750, or save with our annual plan at ₦193,500 per month (billed annually).";
          ...
          {matchesMDUp ? (
            <>
              <Box className={classes.uppercard} disableRipple={true}>
                {/* <Typography variant="h3" style={{marginLeft:"40%", marginBottom:40, width:"100%", fontSize:40, fontWeight:700}}>Our Brand Services</Typography> */}
                <Grid
                  container
                  direction="row"
                ...
                >
                  ...
                  {/* <Typography variant="h4" style={{marginLeft:'50%',marginBottom:30, fontSize:30, fontWeight:700, color:"black"}}>Airport Protocol Services</Typography> */}
                    ...
                    >
                      <Typography variant="h3" style={{marginLeft:'0%',marginBottom:30}}>Key Features</Typography>
                    ...
                    <Grid
                          ...
                          >
                            ...
                            {/* <Typography style={{marginTop:0, padding: 70}}>
                              ...
                              >
                               <Typography variant="h5" style={{marginLeft:'0%',marginBottom:30, fontWeight:700}}>Key Features</Typography>
