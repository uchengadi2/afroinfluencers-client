...
export default function InfluencerDiscoveryHeroSection(props) {
  ...
  console.log('policy is:',props.policy);
                ...
                {/* <Typography style={{marginTop:0, padding: 70}}>
                  ...
                  >
                    <Typography style={{marginTop:40, fontSize:19}}>
                          <ReactMarkdown>Join leading brands redefining influencer marketing through innovative technology. Our platform provides instant access to thousands of fully vetted influencers — backed by deep analytics, audience insights, and engagement data. </ReactMarkdown>
                    </Typography>
                    <Typography style={{marginTop:20, fontSize:19}}>
                          <ReactMarkdown>Whether you’re growing your influencer program or orchestrating complex creator partnerships, we streamline discovery and management to deliver speed, clarity, and total control</ReactMarkdown>
                    </Typography>
                  </Grid>
