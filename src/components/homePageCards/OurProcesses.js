        ...
        <>
          {matchesMDUp ? (
            <>
              <Box className={classes.uppercard} disableRipple={true}>
                ...
                >
                  ...
                  <Typography variant="h3" style={{marginLeft:'40%',marginBottom:30}}>Our Process</Typography>
                    <Grid
                      item
                      // alignItems="center"
            ...
            <Box className={classes.uppercardMobile} disableRipple>
                <Typography variant="h3" style={{marginLeft:'40%',marginBottom:10}}>Our Process</Typography>
                    <Grid
                            container
                            direction="column"
