...
import background from "./../assets/images/influencers/image7.jpg";
...
import InfluencerDiscoveryHeroSection from "./homePageCards/Sections/InfluencerDiscoveryHeroSection";
import InfluencerDiscoveryHowItWorks from "./homePageCards/Sections/InfluencerDiscoveryHowItWorks";
import InfluencerDiscoverySubscriptionModel from "./homePageCards/Sections/InfluencerDiscoverySubscriptionModel";
import InfluencerDiscoveryKeyFeatures from "./homePageCards/Sections/InfluencerDiscoveryKeyFeatures";
import InfluencerDiscoveryHowToGetStarted from "./homePageCards/Sections/InfluencerDiscoveryHowToGetStarted";
...
const BrandInfluencerDiscoveryService = (props) => {
...
const renderLoginForm = () => {
  ...
  console.log('this propsewwwwwww:', props)
  ...
  return (
    <>
      ...
      <Grid container direction="row" className={classes.root}>
                ...
                <Grid sm item className={classes.heroTextContainer}>
                  {matchesMD ? (
                    ...
                    >
                      ...
                      >
                        {" "}
                      Empower your brand with complete control over influencer marketing.  <br />
                      </span>{" "}
                      <span style={{ marginLeft: matchesSM ? 20 : 60 }}>
                      Instantly access verified creator insights and recruit influencers 
                      </span>
                      <br />
                      <span style={{ marginLeft: matchesSM ? 20 : 110 }}>
                      directly — all within a sophisticated, subscription-based 
                      </span>
                      <br />
                      <span style={{ marginLeft: matchesSM ? 20 : 110 }}>
                    ...
                    >
                      ...
                      >
                        {" "}
                       Empower your brand with complete control over   <br />
                      </span>{" "}
                      <span style={{ marginLeft: matchesSM ? 20 : 60 }}>
                      influencer marketing. Instantly access verified 
                      </span>
                      <br />
                      <span style={{ marginLeft: matchesSM ? 30 : 60 }}>
                      creator insights and recruit influencers  
                      </span>
                      <br />
                      <span style={{ marginLeft: matchesSM ? 40 : 60 }}>
                     directly — all within a sophisticated, 
                      </span>
                      <br />
                       <span style={{ marginLeft: matchesSM ? 50 : 60 }}>
                      subscription-based  platform built
                      </span>
                      <br />
        ...
        <InfluencerDiscoveryHeroSection 
        ...
        />
        <InfluencerDiscoveryKeyFeatures 
        ...
        />
        <InfluencerDiscoverySubscriptionModel 
                token={props.token}
                setToken={props.setToken}
                userId={props.userId}
                setUserId={props.setUserId}
        ...
        /> */}
        {/* <HowToGetStarted /> */}
        <InfluencerDiscoveryHowToGetStarted 
           token={props.token}
                setToken={props.setToken}
                userId={props.userId}
                setUserId={props.setUserId}
...
export default BrandInfluencerDiscoveryService;
