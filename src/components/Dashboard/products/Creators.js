      ...
      workingData.map((creator) => {
        allData.push({
          ...
          platforms: creator.platforms,
            ...
            facebookCategory: creator.facebookCategory,
            instagramCategory: creator.instagramCategory,
            tiktokCategory: creator.tiktokCategory,
            twitterCategory: creator.twitterCategory,
            linkedInCategory: creator.linkedInCategory,
            blogCategory: creator.blogCategory,
        });
      });
